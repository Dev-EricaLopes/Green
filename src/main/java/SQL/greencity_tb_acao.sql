...
CREATE TABLE `tb_acao` (
  ...
  `nome_acao` varchar(200) COLLATE utf8mb4_general_ci DEFAULT NULL,
  PRIMARY KEY (`id_acao`)
...
INSERT INTO `tb_acao` VALUES (2,'Coleta seletiva'),(3,'Descarte de lixo eletrônico'),(4,'Descarte de óleo de cozinha'),(5,'Plantio de árvores');
